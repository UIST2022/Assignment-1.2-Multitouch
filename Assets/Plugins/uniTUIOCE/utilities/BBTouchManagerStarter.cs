...
public class BBTouchManagerStarter : MonoBehaviour {
	...
	public BBInputDelegate eventManagerPrefab;
	...
	void Awake() {
		...
		BBInputDelegate go = (BBInputDelegate)Instantiate(eventManagerPrefab,Vector3.zero,Quaternion.identity);
		if (touchReceiver != null)
		{
			go.TouchReceiver=touchReceiver;
		}
	}
